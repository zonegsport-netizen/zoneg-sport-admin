...
export const phoneDigits=value=>{let s=String(value||'').replace(/\D/g,'');if(s.startsWith('84'))s='0'+s.slice(2);return s}
export const staffEmailFromPhone=value=>`${phoneDigits(value)}@staff.zoneg.io.vn`
